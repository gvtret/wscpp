...
std::vector<uint8_t> builder::build_text(
...
std::vector<uint8_t> builder::build_binary(
    const uint8_t* data,
    size_t size,
    bool fin,
    bool mask
...
std::vector<uint8_t> builder::build_close(
...
std::vector<uint8_t> builder::build_ping(
    const uint8_t* data,
    size_t size,
    bool mask
) {
...
std::vector<uint8_t> builder::build_pong(
    const uint8_t* data,
    size_t size,
    bool mask
) {
